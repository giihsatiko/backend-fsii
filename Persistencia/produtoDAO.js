...
export default class ProdutoDAO {
    ...
    async gravar(produto) {
        if (produto instanceof Produto) {
            const sql = `INSERT INTO pedido_produto(prod_descricao, preco_unitario, data_pedido, quantidade, cat_codigo)
                VALUES(?,?,?,?,?)`;
            const parametros = [produto.categoria.descricao, produto.precoCusto,
